...
from smp_base.models_tapping import tap_tupoff, tap, tap_flat, tap_unflat
from smp_base.models_tapping import tap_imol, tap_stack

# from smp_base.models_tapping import tap_imol_fwd, tap_imol_fwd_time, tap_imol_fwd_modality
# from smp_base.models_tapping import tap_imol_inv_old, tap_imol_inv_time, tap_imol_inv_modality
...
if __name__ == "__main__":
    ...
    print('{0} {1}'.format(__file__, __name__))
