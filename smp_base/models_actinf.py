...
class ActInfHebbianSOM(ActInfModel):
    def __init__(self, idim = 1, odim = 1, numepisodes = 100, mapsize_e = 10, mapsize_p = 10, som_lr = 1e-1):
        """ActInfHebbianSOM
